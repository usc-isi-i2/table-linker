...
class MatchContext(object):
    def __init__(self, input_path, similarity_string_threshold, similarity_quantity_threshold,
        ...
        print(f'read-context-file--{end-start}', file=sys.stderr)
    ...
    def calculate_property_value(self):
        ...
        print(f'calpropval-loop1--{end-start}', file=sys.stderr)
        property_value_list = []
        ...
        print(f'calpropval-loop2--{end-start}', file=sys.stderr)
    ...
    def process_data_context(self):
        ...
        print(f'recalculate-loop1--{end-start}s', file=sys.stderr)
        start = time.time()
        ...
        print(f'recalculate-loop2--{end-start}s', file=sys.stderr)
        start = time.time()
